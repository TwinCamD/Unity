...
public class TwinCamManager : MonoBehaviour {

    [SerializeField] private float _fixedDeltaTime = 0.02f;//FixedUpdateの時間
    ...
    //デモ
    private int sendsend = 300;
    private double rrr = 898.3274979;
